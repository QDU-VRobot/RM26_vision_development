    ...
    if (msg->id == "outpost")
        {
            ...
            const float tmp_yaw = tar_yaw + static_cast<float>(i) * 2.0f * PI /
            ...
            if(msg->position.z >= 1.076 && msg->position.z <= 1.156 && msg->v_yaw > 0)
            {
                ...
                tar_position[i].z = static_cast<float>(msg->position.z) + static_cast<float>(i) * static_cast<float>(0.1);
                tar_position[i].yaw = tmp_yaw;
                std::cout << tar_position[i].z << std::endl;
            }
            ...
            else if(msg->position.z >= 1.176 && msg->position.z <= 1.256 && msg->v_yaw > 0)
            {
                tar_position[i].x = static_cast<float>(msg->position.x) - r * std::cos(tmp_yaw);
                tar_position[i].y = static_cast<float>(msg->position.y) - r * std::sin(tmp_yaw);
                tar_position[2].z = static_cast<float>(msg->position.z) + static_cast<float>(0.1);
                tar_position[3].z = static_cast<float>(msg->position.z) - static_cast<float>(0.1);
                tar_position[i].yaw = tmp_yaw;
                std::cout << tar_position[i].z << std::endl;
            }
            ...
            else if(msg->position.z >= 1.276 && msg->position.z <= 1.356 && msg->v_yaw > 0)
            {
                ...
                tar_position[i].y = static_cast<float>(msg->position.y) - r * std::sin(tmp_yaw);
                tar_position[2].z = static_cast<float>(msg->position.z) - static_cast<float>(0.1);
                tar_position[3].z = static_cast<float>(msg->position.z) - static_cast<float>(0.2);
                tar_position[i].yaw = tmp_yaw;
                std::cout << tar_position[i].z << std::endl;
            }
            ...
            else if(msg->position.z >= 1.076 && msg->position.z <= 1.156 && msg->v_yaw < 0)
            {
                tar_position[i].x = static_cast<float>(msg->position.x) - r * std::cos(tmp_yaw);
                tar_position[i].y = static_cast<float>(msg->position.y) - r * std::sin(tmp_yaw);
                tar_position[2].z = static_cast<float>(msg->position.z) + static_cast<float>(0.2);
                tar_position[3].z = static_cast<float>(msg->position.z) + static_cast<float>(0.1);
                tar_position[i].yaw = tmp_yaw;
                std::cout << tar_position[i].z << std::endl;
            }
