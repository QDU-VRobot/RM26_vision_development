...
## 概述  
本仓库桥接 ROS2 与 LibXR（上位机 ↔ 本库 ↔ 下位机）。代码位于 src/ros2libxr.cpp、接口声明在 include/ros2_libxr/ros2libxr.hpp。
...
- 修改位置和格式请参考 include/ros2_libxr/ros2libxr.hpp 中的 SharedTopic/SharedTopicClient 定义。
